export default ({setCreateShipmentModal, allShipmentsdata})=>{
  const converTime = (time)=>{
    ...
    const dataTime = new Init.DateTimeFormat("en-US",{
      year:"numeric",
      month:"2-digit",
      day:"2-digit",
    }).format(newTime);
    ...
    <div className="max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="items-start justify-between md:flex">
        ...
        <p 
          ...
          className="inline-block px-4 py-2 text-white duration-150 font-medium bg-gray-800 hover:bg-gray-700 avtive:bg-gray-900 md:text-sm rounded-lg md:inline-flex"
          >
            Add Tracking
          </p>
        </div>
